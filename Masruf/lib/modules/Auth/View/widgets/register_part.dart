        ...
        return Column(
          children: [
            ...
            CustomTextFieldWidget(
              ...
              suffix: Icon(state.isPasswordVisible
                  ? Icons.visibility
                  : Icons.visibility_off),
              onSuffixTap: () => bloc.add(TogglePasswordVisibilityEvent()),
            ...
            CustomTextFieldWidget(
              ...
              validator: (v) => Validator.validateConfirmPassword(
                  bloc.passwordController.text.trim(), v!),
            ...
            CustomButtonWidget.primary(
              width: 320.w,
              context: context,
              onTap: () => bloc.add(RegisterEvent(context)),
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () => bloc.add(ToggleAuthModeEvent()),
